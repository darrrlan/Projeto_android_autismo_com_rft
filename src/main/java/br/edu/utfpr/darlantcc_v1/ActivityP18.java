...
public class ActivityP18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityP19.iniciar(ActivityP18.this,PESSOA,ID);
        ...
        imagem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ActivityP18.this,
    ...
    public static void iniciar(AppCompatActivity origem, Pessoa pessoa, String id){
        ...
        Intent intent = new Intent(origem, ActivityP18.class);
