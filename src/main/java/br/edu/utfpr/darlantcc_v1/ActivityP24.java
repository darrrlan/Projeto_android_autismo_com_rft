...
public class ActivityP24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityP25.iniciar(ActivityP24.this,PESSOA,ID);
        ...
        imagem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ActivityP24.this,
    ...
    public void atualizarResposta(int id){
        ...
        resposta.setR24(String.valueOf(id));
    ...
    public static void iniciar(AppCompatActivity origem, Pessoa pessoa, String id){
        ...
        Intent intent = new Intent(origem, ActivityP24.class);
