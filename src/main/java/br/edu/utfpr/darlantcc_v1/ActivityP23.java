...
public class ActivityP23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityP24.iniciar(ActivityP23.this,PESSOA,ID);
        ...
        imagem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ActivityP23.this,
    ...
    public void atualizarResposta(int id){
        ...
        resposta.setR23(String.valueOf(id));
    ...
    public static void iniciar(AppCompatActivity origem, Pessoa pessoa, String id){
        ...
        Intent intent = new Intent(origem, ActivityP23.class);
