...
public class ActivityP5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //destino             origem
                //ActivityP5.iniciar(ActivityP3.this,PESSOA,ID);
                ActivityP6.iniciar(ActivityP5.this,PESSOA,ID);
        ...
        imagem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ActivityP5.this,
    ...
    public void atualizarResposta(int id){
        ...
        resposta.setR5(String.valueOf(id));
    ...
    public static void iniciar(AppCompatActivity origem, Pessoa pessoa, String id){
        ...
        Intent intent = new Intent(origem, ActivityP5.class);
