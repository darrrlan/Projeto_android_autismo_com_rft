...
public class ActivityP16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityP17.iniciar(ActivityP16.this,PESSOA,ID);
        ...
        imagem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ActivityP16.this,
    ...
    public void atualizarResposta(int id){
        ...
        resposta.setR16(String.valueOf(id));
    ...
    public static void iniciar(AppCompatActivity origem, Pessoa pessoa, String id){
        ...
        Intent intent = new Intent(origem, ActivityP16.class);
